...
export default function Footer() {
  return (
    <footer className="bg-[#1e1e1e] text-white py-10 px-10 h-[600px]">
      <div className="max-w-8xl mx-auto grid grid-cols-[50%_repeat(3,_1fr)] gap-5 pt-[50px]">
        ...
        <div className="text-left ml-9">
          ...
          <p className="text-[16px] text-grey pb-11">
            ...
            aspects of your online presence. From SEO and social media marketing to <br />
            content creation, PPC advertising, and analytics, we have the expertise and resources to  <br />
            handle your diverse marketing needs effectively and efficiently.
          </p>
             
          <div className="flex space-x-4 mt-22 mb-6 text-white-400">
            <span className="rounded-full bg-white text-blue-500 px-4 py-4">
              <FaFacebookF />
            </span>
            <span className="rounded-full bg-white text-blue-500 px-4 py-4">
              <FaYoutube />
      ...
      {/* Bottom Footer */}
      <div className="mt-10 ml-9 text-left pt-4 text-xl text-white pb-7">
